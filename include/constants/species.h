...
// These indexes identify the Pokemon ID in the Pokemon data structure
// For external tooling and trade/battle compatibility with other games,
// DO NOT CHANGE THESE!
...
// KANTO_SPECIES_END is used on checks to block evolution/trading/etc.
//   It must be equal to the highest indexed Kanto Pokemon
//   Originally, this is MEW 151, but with the adapted 'dex, it is BLISSEY 242
//   This does mean that most Johto Pokemon can now be evolved/traded/etc.,
//   but these SPECIES indexes are not safe to renumber

#define KANTO_SPECIES_END   SPECIES_BLISSEY
